...
: ${AMENT_CURRENT_PREFIX:="/home/jetson/github/auton_sys-23/utils/install/rover_utils"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_utils/environment/library_path.sh"
