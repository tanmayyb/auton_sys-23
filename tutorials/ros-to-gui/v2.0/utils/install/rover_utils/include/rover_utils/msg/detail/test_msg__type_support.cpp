...
{
  new (message_memory) rover_utils::msg::TestMsg(_init);
}

void TestMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rover_utils::msg::TestMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TestMsg_message_member_array[2] = {
  {
    ...
    offsetof(rover_utils::msg::TestMsg, point),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rover_utils::msg::TestMsg, my_float),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TestMsg_message_members = {
  ...
  2,  // number of fields
  sizeof(rover_utils::msg::TestMsg),
...
{
  return &::rover_utils::msg::rosidl_typesupport_introspection_cpp::TestMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rover_utils, msg, TestMsg)() {
  return &::rover_utils::msg::rosidl_typesupport_introspection_cpp::TestMsg_message_type_support_handle;
}
