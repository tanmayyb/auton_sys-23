...
#ifndef ROVER_UTILS__ACTION__DETAIL__MINIMAL_WALK__TYPE_SUPPORT_H_
#define ROVER_UTILS__ACTION__DETAIL__MINIMAL_WALK__TYPE_SUPPORT_H_
...
#endif  // ROVER_UTILS__ACTION__DETAIL__MINIMAL_WALK__TYPE_SUPPORT_H_
